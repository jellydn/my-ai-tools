...
> **Agent context:** See `AGENTS.md` for wiki-specific agent instructions. See the root `../AGENTS.md` for project-wide conventions and tooling (bash scripts, git safety, bats tests, etc.).
...
**Domain:** my-ai-tools — configuration management for AI coding assistants

**Purpose:** Build a structured, compounding knowledge base on this repo's tools, configs, MCP servers, skills, hooks, and workflows so insights across sources can be synthesized without re-reading everything.
