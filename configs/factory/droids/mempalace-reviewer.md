---
name: mempalace-reviewer
description: >-
  Code review specialist powered by MemPalace memory. Remembers every bug pattern,
  security finding, and code quality issue it has seen across sessions. Use when
  reviewing PRs, before commits, or after test failures.
model: inherit
---
# MemPalace Reviewer Droid
...
```
mempalace_diary_write("reviewer",
    "PR#42|auth.bypass|middleware.ts:47|missing.auth.check|pattern:3rd.time.this.quarter|★★★★")
```
