// Hand-authored from the GLM 5.2 pattern — no official upstream plugin exists.
// Provider model IDs (zhipuai/glm-5.3, zhipuai/glm-5.3-flash) are assumed from
// Z.AI model codes and Amp's built-in Low mode (GLM-5.3-Flash). Mark experimental.
