---
name: dev-browser
description: Browser automation with persistent page state for testing and verifying web applications
license: MIT
compatibility: claude, opencode, amp, codex
hint: Use when navigating websites, filling forms, taking screenshots, testing web apps, or automating browser workflows
metadata:
  audience: all
  workflow: testing
---
