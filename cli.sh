...
main() {
	...
	echo "  2. Run 'claude' to start Claude Code (or 'kimi' for Kimi Code, 'agy' for Antigravity CLI, 'cmd' for Command Code, 'grok' for Grok CLI, 'mimo' for MiMo-Code, 'ctx' for agent-history search)"
